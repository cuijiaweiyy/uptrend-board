// 自动生成，请勿手改。来源：pywencai/hexin-v.js
// 处理：剥离 jsdom 引导与测试代码；顶部 var 声明还原原脚本的隐式全局（严格模式需要）。
export default function hexinCore({window, document, navigator, location, screen, localStorage, sessionStorage, top, parent, frames, self, ActiveXObject, XMLHttpRequest, Image, escape, unescape, btoa, atob, setImmediate, process, Buffer, postMessage, addEventListener, removeEventListener}) {
var v, TOKEN_SERVER_TIME, BROWSER_LIST, _red, time, plugin_num;
